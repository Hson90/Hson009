# commands for source Ralls by ~ @TEAM_ADX
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 ADX𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TEAM_ADX) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX����������������(t.me/TEAM_ADX) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 ADX𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TEAM_adx) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [ADX𝞝 𝙏𝙃𝙊𝙉](t.me/TEAM_ADX) 𓆪"
            )

########################  SOURCE ADX ~ BY: @HHFEE (@TEAM_ADX)  ########################
...
async def _(event):
    ...
    if input_str == "م2":
        ...
        if r == 0:
            ...
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 ADX𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TRAM_ADX) 𓆪\n **⌔╎قائـمه اوامر التسليه :** \n\n⪼ `.شرح تسليه` \n⪼ `.شرح تسليه1` \n⪼ `.شرح تسليه2` \n⪼ `.شرح تسليه3` \n⪼ `.شرح تسليه4` \n⪼ `.شرح تسليه5` \n⪼ `.شرح تسليه7` \n⪼ `.شرح تسليه8` \n\n**- جديـده :**\n\n⪼ `.شرح تسليه9` \n⪼ `.شرح تسليه10` \n\n\n**⌔╎قائـمه اوامر التسليه الجديده حقـوق سـورس زد ثــون :**\n\n⪼ `.كشف` \nبالـرد / المعرف/ الايدي \n**امـر تسـليه كشـف حيـوان 😂🐴**\n\n⪼ `.مشهور`\n بالـرد /المعرف /الايدي\n**امـر تسـليه زوجنـي من مشهـور 👨‍⚖💍** \n\n⪼ `.مشهوره`\n بالرد /المعرف /الايدي \n **امـر تسـليه زوجنـي من مشهـوره 👰🏻‍♀💍**\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX𝙏𝙃𝙊𝙉](t.me/TEAM_ADX) 𓆪"
            )

########################  SOURCE ADX𝙏𝙃𝙊𝙉 ~ BY: @HHFEE (@TEAM_ADX)  ########################
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TEAM_ADX) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX](t.me/TEAM_ADX) 𓆪")
...
async def _(event):
    ...
    if input_str == "م3":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹SE ADX����������������- 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX𝙃𝙊𝙉](t.me/team_adx) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 TEAM ADX𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/team_adx) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 adx����������������(t.me/team_adx) 𓆪"
            )
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 adx 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/team_axc) 𓆪\n **⌔╎قائـمه اوامر التلكراف :** \n⪼ `.تلكراف ميديا ` \n⪼ `.تلكراف نص ` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX](t.me/TEAM_ADX) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 adx 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر التاك :** \n⪼ `.تاك ` \n⪼ `.للكل ` + الكلام \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 adx](t.me/team_adx) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 adx 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/tean_adx) 𓆪\n **⌔╎قائـمه اوامر النت :** \n⪼ `.بنك`  \n⪼ `.سرعه النت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 adx](t.me/team_adx) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝑡dx 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TEAM_ADX) 𓆪\n **⌔╎قائـمه اوامر السورس :** \n⪼ `.السورس ` لعرض معلومات السورس \n⪼ `.المطور` \n⪼ `.المده ` لعرض مدة استخدام السورس \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 TEAM ADX](t.me/TEAM_ADX) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/TEAM_ADX) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX𝐒](t.me/TEAM_ADX) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝑁DX 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/TEAM_ADX) 🧸♥️𓆪\◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐**\n 𓄂 ༗\n")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 ADX 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/TEAM_ADX) 🗑♻️𓆪\◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
########################  SOURCE Ralls ~ BY: @HHFEE (@TEAM_ADX)  ########################
...
DEFAULTUSER = "ADX"
CAT_IMG = "https://telegra.ph/file/37d16e544e07168b373fe.jpg.jpg"
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 ADX 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ IHJJJ ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @IHJJJ༗\n"
        cat_caption += f"◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐"
        ...
        await edit_or_reply(
            ...
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @HHFEE༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @TEAM_ADX ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧADXⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )
